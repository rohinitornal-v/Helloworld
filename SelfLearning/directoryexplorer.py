...
#/Users/rohinitv/Documents/PycharmProjects/PythonProject/Helloworld
...
def check_file_exists(path, filename):
    ...
    exists = os.path.isfile(full_path)  # check if it's a file
    return exists
...
def project_directory(path):
    ...
    print(f"Current Project Directory: {abs_path}\n")
